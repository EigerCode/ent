...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Deployment, c.EnrollmentToken, c.LogicalDisk, c.MemorySlot, c.Metadata,
		c.Monitor, c.Netbird, c.NetbirdSettings, c.NetworkAdapter, c.OperatingSystem,
		...
		c.User, c.UserTenant, c.WingetConfigExclusion,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		EnrollmentToken, LogicalDisk, MemorySlot, Metadata, Monitor, Netbird,
		...
		Update, User, UserTenant, WingetConfigExclusion []ent.Hook
	}
	inters struct {
		Agent, Antivirus, App, Authentication, Certificate, Computer, Deployment,
		EnrollmentToken, LogicalDisk, MemorySlot, Metadata, Monitor, Netbird,
		...
		Printer, Profile, ProfileIssue, RecoveryCode, Release, Revocation, Rustdesk,
		Server, Sessions, Settings, Share, Site, SystemUpdate, Tag, Task, Tenant,
		Update, User, UserTenant, WingetConfigExclusion []ent.Interceptor
	}
)
