...
const (
	...
	InstallLogsColumn = "software_package_install_logs"
...
func PlatformValidator(pl Platform) error {
	...
	case PlatformDarwin, PlatformWindows:
		return nil
	default:
		return fmt.Errorf("softwarepackage: invalid enum value for platform field: %q", pl)
	}
}
...
func RestartActionValidator(ra RestartAction) error {
	...
	case RestartActionNone, RestartActionRequireRestart, RestartActionRequireLogout, RestartActionRecommendRestart:
		return nil
	default:
		return fmt.Errorf("softwarepackage: invalid enum value for restart_action field: %q", ra)
	}
}
